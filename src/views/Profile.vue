  ...
  methods: {
    ...
    async saveProfile() {
      try {
        ...
        const response = await axios.put('http://localhost:3003/api/usuarios', {
          correo,
          contrasena: password, // Cambiar 'contraseña' a 'contrasena' según el nombre en el modelo del backend
          ...nuevoPerfil // Incluir los datos del nuevo perfil
        })
        ...
        // Cambiar a modo de edición a falso
        this.editMode = false
      } catch (error) {
